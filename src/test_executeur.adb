...
begin
    ...
    affectation(mem, 2, new T_Element'(Type_Element => Caractere, Valeur_Caractere => 'c'));
    ...
    affectation(mem, 2, new T_Element'(Type_Element => Chaine, Valeur_Chaine => To_Unbounded_String("ada")));
    ...
    pragma Assert(Renvoie_Variable(mem, 1).Valeur.Valeur_Entier = 10);
