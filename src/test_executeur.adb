...
begin
    ...
    pragma Assert(Renvoie_Variable(Ma_Variable, 2).Valeur = -8);
    
    --opération : var2 <- 2 * 3
    operation(Ma_Variable, 2, 2, 3, -5);
    pragma Assert(Renvoie_Variable(Ma_Variable, 2).Valeur = 6);
    
    --opération : var2 <- 6 / 3
    operation(Ma_Variable, 2, 6, 3, -6);
    pragma Assert(Renvoie_Variable(Ma_Variable, 2).Valeur = 2);
