...
package Parser is
   ...
   procedure Lire_Fichier (nom_fichier : in String; Programme: out T_Programme;Correspondance_Variable : out T_Correspondance_Variable);
   
   
   procedure Afficher_Programme (Programme : in T_Programme);

   function Split_String(input : in String) return T_Split_String_Tab;
