...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_tri_tableau" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#c06dcba4#;
   pragma Export (C, u00001, "tri_tableauB");
   ...
   u00141 : constant Version_32 := 16#8f461df5#;
